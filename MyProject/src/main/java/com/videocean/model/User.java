...
import com.videocean.exception.*;
...
public class User implements IUser {
	 ...
	 */
	@Override
	public void addSubscrition(User user) throws UserException {
		if (user != null) {
	 ...
	 */
	@Override
	public void removeFollower(IUser user) throws UserException {
		if (user != null) {
	 ...
	 */
	@Override
	public void removeSubscription(IUser user) throws UserException {
		if (user != null) {
