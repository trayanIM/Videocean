                    ...
                    <c:forEach var="clip" items="${playlist}" step="1" begin="0" end="19">
                        <div class="col-md-3 resent-grid recommended-grid slider-first">
                            <div class="resent-grid-img recommended-grid-img">
                                <a href="single-${playlist.playlistID}"><img src="${playlist.getFirstClip.clipURL}"
                                                                             alt=""/></a>
                                ...
                                <div class="slid-bottom-grids">
                                    <div class="slid-bottom-grid">
                                        <p class="author author-info"><a href="#"
                                                                         class="author">${playlist.owner.fullName}</a>
                                        </p>
                                    </div>
                        ...
                        <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                            ...
                            <div class="resent-grid-info recommended-grid-info">
                                ...
                                <ul>
                                    ...
                                    <li class="right-list"><p class="views views-info"> ${playlist.viewsOfPlaylist}
                                        views</p></li>
                                </ul>
                            </div>
                        </div>
