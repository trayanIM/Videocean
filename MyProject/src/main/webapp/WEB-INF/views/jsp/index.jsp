            ...
            <c:forEach var="clip" items="${subClips}" step="1" begin="0" end="2">
                <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                    <div class="resent-grid-img recommended-grid-img">
                        <a href="single-${clip.clipID}">
                            <video width="354" height="200">
                                <source src="load-${clip.clipID}"></source>
                            </video>
                        </a>
                        <!--  <div class="time">
                            <p>3:</p>
                    ...
                    <div class="resent-grid-info recommended-grid-info">
                        ...
                        <ul>
                            <li><p class="author author-info"><a href="user-${clip.owner.userID}"
                                                                 class="author"> ${clip.owner.fullName}</a></p></li>
                            ...
                            <div class="animated-grids">
                                ...
                                <c:forEach var="cl" items="${clips}" step="1" begin="0" end="19">
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                        <div class="resent-grid-img recommended-grid-img">
                                            <a href="single-${cl.clipID}">
                                                <video width="260" height="180">
                                                    <source src="load-${cl.clipID}"></source>
                                                </video>
                                            </a>
                                        ...
                                        <div class="resent-grid-info recommended-grid-info">
                                            ...
                                            <div class="slid-bottom-grids">
                                                <div class="slid-bottom-grid">
                                                    <p class="author author-info"><a href="user-${cl.owner.userID}"
                                                                                     class="author">${cl.owner.fullName}</a>
                                                    </p>
                                                </div>
