                ...
                <div class="share">
                    ...
                    <ul>
                        <li><!--  <a target="_blank"
                            ...
                            <a href="#"
                               class="icon twitter-icon" onclick="return saveDislike();">Like <span
                                    id="dislike-count">${dislikes}</span></a>
                            <script>
                ...
                <c:forEach var="cl" items="${clips}" step="1" begin="0" end="6">
                    <div class="single-right-grids">
                        ...
                        <div class="col-md-8 single-right-grid-right">
                            ...
                            <p class="author"><a href="user-${cl.owner.userID}" class="author">${cl.owner.fullName}</a>
                            </p>
