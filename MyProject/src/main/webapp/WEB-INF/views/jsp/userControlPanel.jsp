                    ...
                    <div class="recommended-info">
                        ...
                        <div class="recommended-info">
                            <div class="heading-right">
                                ...
                                <a href="#small-dialog8" class="play-icon popup-with-zoom-anim"
                                   onclick="return saveFollowers();">Subscribe</a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <!-- added subscribe-->
                            ...
                            <div class="resent-grid-info recommended-grid-info">
                                ...
                                <ul>
                                    <li><p class="author author-info"><a href="#"
                                                                         class="author"> ${clip.owner.fullName}</a></p>
                                    </li>
